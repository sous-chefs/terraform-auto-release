...
resource "kubernetes_secret" "auto-release-github-sous-chef-backend" {
  metadata {
    name      = "auto-release-github"
...
module "sous-chefs-label-manager" {
  ...
  github_token_secret_name = kubernetes_secret.auto-release-github-sous-chef-backend.metadata[0].name
